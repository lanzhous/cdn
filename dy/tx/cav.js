...
CAV={FRONT:0,BACK:1,DOUBLE:2,SVGNS:"/www.w3.org/2000/svg"};CAV.Array=typeof Float32Array==="function"?Float32Array:Array;CAV.Utils={isNumber:function(a){return!isNaN(parseFloat(a))&&isFinite(a)}};
...
function Victor(container, anitOut){
	if (!!document.createElement("canvas").getContext) {
		...
		var z = document.getElementById(container || "container1");
